...
void github_bench(void) {
    ...
    bench.insert(GITHUB_DATA_ADDR,
                 ...
                 total_points_count, parse_line_github);
...
void nyc_bench(void) {
    ...
    bench.insert(NYC_DATA_ADDR,
                 ...
                 total_points_count, parse_line_nyc);
...
void tpch_bench(void) {
    ...
    bench.insert(TPCH_DATA_ADDR,
                 ...
                 total_points_count, parse_line_tpch);
...
void sensitivity_num_dimensions_9(void) {
    ...
    bench.range_search_random(
        "sensitivity/tpch_query_dimensions" + identification_string + "_" + "9",
        get_random_query_tpch<9>, micro_tpch_size * selectivity_upper,
...
void sensitivity_num_dimensions_8(void) {
    ...
    bench.range_search_random(
        "sensitivity/tpch_query_dimensions" + identification_string + "_" + "8",
        get_random_query_tpch<8>, micro_tpch_size * selectivity_upper,
        micro_tpch_size * selectivity_lower);
}
...
void sensitivity_num_dimensions_7(void) {
    ...
    bench.range_search_random(
        "sensitivity/tpch_query_dimensions" + identification_string + "_" + "7",
        get_random_query_tpch<7>, micro_tpch_size * selectivity_upper,
        micro_tpch_size * selectivity_lower);
}
...
void sensitivity_num_dimensions_6(void) {
    ...
    bench.range_search_random(
        "sensitivity/tpch_query_dimensions" + identification_string + "_" + "6",
        get_random_query_tpch<6>, micro_tpch_size * selectivity_upper,
        micro_tpch_size * selectivity_lower);
}
...
void sensitivity_num_dimensions_5(void) {
    ...
    bench.range_search_random(
        "sensitivity/tpch_query_dimensions" + identification_string + "_" + "5",
        get_random_query_tpch<5>, micro_tpch_size * selectivity_upper,
        micro_tpch_size * selectivity_lower);
}
...
void sensitivity_num_dimensions_4(void) {
    ...
    bench.range_search_random(
        "sensitivity/tpch_query_dimensions" + identification_string + "_" + "4",
        get_random_query_tpch<4>, micro_tpch_size * selectivity_upper,
        micro_tpch_size * selectivity_lower);
}
...
void sensitivity_selectivity(void) {
    ...
    bench.insert(TPCH_DATA_ADDR,
                 ...
                 total_points_count, parse_line_tpch);
    bench.range_search_random(
        "sensitivity/tpch_query_selectivity" + identification_string,
        get_random_query_tpch<TPCH_DIMENSION>, total_points_count, 1);
}
...
void sensitivity_treeblock_sizes(int treeblock_size) {
    ...
    p_key_to_treeblock_compact =
        new bitmap::CompactPtrVector(total_points_count);
    bench.insert(TPCH_DATA_ADDR,
                 "sensitivity/tpch_insert_treeblock_sizes_" +
                     std::to_string(treeblock_size),
                 total_points_count, parse_line_tpch);

    bench.get_storage("sensitivity/tpch_storage_treeblock_sizes_" +
                      std::to_string(treeblock_size));
    bench.lookup("sensitivity/tpch_lookup_treeblock_sizes_" +
                 std::to_string(treeblock_size));
    bench.range_search(TPCH_QUERY_ADDR,
                       "sensitivity/tpch_query_treeblock_sizes_" +
                           std::to_string(treeblock_size),
                       get_query_tpch<TPCH_DIMENSION>);
}
