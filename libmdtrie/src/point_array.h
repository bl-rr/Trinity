...
template <dimension_t DIMENSION> class point_array {
  public:
    explicit point_array() {}

    void add_leaf(data_point<DIMENSION> *p) { points_.push_back(p); }
    ...
    inline n_leaves_t size() const { return points_.size(); }
