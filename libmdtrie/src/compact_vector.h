...
namespace bitmap
{
  ...
  public:
    ...
    bool operator!=(const const_vector_iterator &it) const { return *this != it; }
  ...
  public:
    ...
    CompactPrimaryVector()
        : CompactVector<uint64_t, 46>()
    {
    }
    ...
    {
      CompactVector<uint64_t, 46>::Set(idx,
                                       reinterpret_cast<uint64_t>(val) >> 20ULL);
    }
    ...
    void set_ptr(pos_type idx, uintptr_t ptr) { Set(idx, At(idx) & (ptr << 2)); }
